  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_product_modal" class="btn btn-outline-primary btn-sm">Add New Product</a>
      	</div>
      </div>
        ...
        <form id="add-product-form" enctype="multipart/form-data">
            ...
            <div class="col-12">
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Keywords <small>(eg: dissolve, stand pot, organic)</small></label>
